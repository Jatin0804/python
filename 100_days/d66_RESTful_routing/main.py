...
def get_cafe_at_location():
    ...
    if all_cafes:
        ...
        return jsonify(error = {"Not Found": "No Cafes found with this location"}), 404
...
def add_cafe():
    if request.method == "GET":
        return "This is a POST only HTTP"
...
@app.route("/update/<int:cafe_id>", methods=["GET", "PATCH"])
def update_cafe(cafe_id):
    new_price = request.args.get("new_price")

    if request.method == "GET":
        return "This is a PATCH only HTTP"
    ...
    if request.method == "PATCH":
        if cafe:
            ...
            return jsonify(error = {"Not Found": "No Cafes found with this id"}), 404
